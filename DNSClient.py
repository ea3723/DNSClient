...
if __name__ == '__main__':
    ...
    print("Does the local DNS server match with the public DNS server for all domains?", result)
    
    result = query_local_dns_server('nyu.edu.', question_type)
    print(f"The local DNS server IP for nyu.edu is: {result}")
